...
export default function LoginPage() {
  ...
  const { login, loginWithEmail, verifyOtp, googleAuth, checkAuth } = useAuthStore()
  ...
  const handleEmailLogin = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || 'خطأ في البريد الإلكتروني أو كلمة المرور')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="hidden md:flex md:w-1/2 bg-navy-900 relative overflow-hidden flex-col justify-center p-12 lg:p-24">
        ...
        <div className="relative z-10 text-white">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-gold-400">بوابتك الموثوقة</span>
          </h1>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white relative">
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-navy-500">اختر طريقة تسجيل الدخول</p>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-navy-100/50 border border-navy-100 p-8 sm:p-10">
              ...
              <form onSubmit={handleEmailLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <button type="button" className="text-xs text-primary-500 font-semibold hover:text-primary-700">نسيت كلمة المرور؟</button>
                  </div>
            ...
            {mode === 'google' && (
              <div className="space-y-6 text-center">
                <p className="text-navy-500 text-sm">سجل الدخول باستخدام حساب Google الخاص بك</p>
                ...
                {!GOOGLE_CLIENT_ID && (
                  <p className="text-xs text-navy-400">تسجيل الدخول بواسطة Google غير متاح حالياً (قريباً)</p>
                )}
              </div>
            )}
          </div>
